...
public class PersonaDAO {
	...
	FROM 
	    ...
	    modelo m
	WHERE
		v.id_propietario = p.id AND
	    m.id = v.id_modelo AND
	    p.id = 2;
	 */
	...
	private static final String SQL_GET_ALL_VEHICULOS_USER = "SELECT";
	...
	public HashMap<Long, Vehiculo> getAllVehiculosByUser() {
